  ...
  return (
    <div className="profile-page">
      ...
      <div className="profile-content">
        ...
        <div className="profile-item" onClick={() => {window.open(`https://t.me/lAlexonl`, "_blank", "noopener,noreferrer");} }>
          <div className="item-text">
        ...
        {/* <div className="profile-item" onClick={() => navigate('/report/38')}>
          <div className="item-text">
            <span className="item-title">Отчёт</span>
            <span className="item-subtitle">Отчёт</span>
          </div>
          <svg
            width="6"
            height="12"
